...
<div class="container">
 ...
 <div class="col-6">
<img class="img-fluid rounded " src="https://s3.ap-south-1.amazonaws.com/cdn-shebaxyz/images/categories_images/thumbs/1594641454_acrepairservices.jpg" alt="">
 </div>
 <div class="col-6">

 <!-- list -->
 <ul class="list-group">
  <li class=" text-center list-group-item list-group-item-warning text-dark "> <i class="fas fa-fan  "  ></i>  AC Servicing</li>


  <li class="list-group-item list-group-item-success"> <i class="fas fa-check-circle mr-5 "></i>Trusted & Reliable AC Technicians</li>
  ...
  <li class="list-group-item list-group-item-info"> <i class="fas fa-check-circle mr-5 "></i> Expert Technician</li>
  <li class="list-group-item list-group-item-dark"> <i class="fas fa-check-circle mr-5 "></i> Use Digital tools</li>
...
<div class="row">
  ...
  <ul>
    <li style="font-size:20px" >Only service charge</li>
    <li style="font-size:20px" >7 Days service warranty</li>
  ...
  <ul>
    <li style="font-size:20px" > Price of materials or parts</li>
    <li style="font-size:20px" >Transportation cost for carrying new materials/parts</li>
    <li style="font-size:20px" >Warranty given by manufacturer</li>
  </ul>
  </div>
  ...
  <ul>
    <li style="font-size:20px" >AC Basic Servicing</li>
    <li style="font-size:20px" >AC Master Service</li>
    <li style="font-size:20px" >AC Water Drop Solution</li>
    <li style="font-size:20px" >AC Jet Wash</li>
  </ul>
  </div>
...
<ul>
  ...
  <li>AC Shifting Service</li>
  <li>AC Compressor Fitting</li>
  <li>AC Dismantling</li>
  <li>AC Jet Wash</li>
  <li>AC Service Repairing </li>
</ul>
