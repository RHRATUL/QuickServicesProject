...
<div class="container">
 ...
 <div class="col-6">
<img class="img-fluid rounded " src="images/tutor.jpg" alt="">
 </div>
 <div class="col-6">

 <!-- list -->
 <ul class="list-group">
  <li class=" text-center list-group-item list-group-item-info text-dark "> <i class="fas fa-book-open  "  ></i> Tuition Services</li>


  <li class="list-group-item list-group-item-success"> <i class="fas fa-check-circle mr-5 "></i>Trusted & Reliable Teacher</li>
  <li class="list-group-item list-group-item-success"> <i class="fas fa-check-circle mr-5 "></i> A+ Guaranty</li>
  <li class="list-group-item list-group-item-success"> <i class="fas fa-check-circle mr-5 "></i>Bsc in Software Engineering ,DIU</li>
  <li class="list-group-item list-group-item-success"> <i class="fas fa-check-circle mr-5 "></i> Expert Teacher</li>
...
<div class="row">
  ...
  <ul>
    <li style="font-size:20px" >Well-trained Teacher</li>
    <li style="font-size:20px" >Very Good Background </li>
  ...
  <ul>
    <li style="font-size:20px" >Custom Subject</li>
    <li style="font-size:20px" >Full course</li>
    <li style="font-size:20px" >Chapter Contact</li>
...
<h2>Details</h2>
<p>
At Quick service you can hire expert teacher(tuition) service near you. Our professional Service Providers will give you the best AC repair service. From general inspection, to changing AC parts you can avail every AC related service within a few moments.

<h4>About Quick Service Tuition Service</h4>

<p>Quick Service is the largest marketplace in Bangladesh where we serve you with every possible service.Teaching service is one of our services to repair all types of AC related problems. We deliver expert and AC repair services with integrity from our professional service providers.
</p>
...
<ul>
  <li>Well-trained Teacher.</li>
  <li>A+ money Back Guaranty</li>
...
<ul>
  ...
  <li>Full Month 18000</li>
  <li>Per subject 3000 </li>
...
<h4>Guaranty:</h4>
<ul>
  <li>Vai + na Paile Taka Ferot</li>
  <li>Porte na chaile kothin mair Hobe</li>
...
<!-- Order Now  -->
<div class="jumbotron">
  <h1 class="display-4"> Contact Now</h1>
